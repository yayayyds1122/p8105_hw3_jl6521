...
```
Description: the dataset records the ride ID, ride type, the day of the ride, duration of the ride, start and end station time, and also if it's citi bike member or casual riders.
