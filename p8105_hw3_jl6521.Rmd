...
```
Comment: from the table, the 5 most popular starting stations are Pier 61 at Chelsea Piers, University Pl & E 14 St, W 21 St & 6 Ave, West St & Chambers St, and W31 St & 7 Ave. 
...
```
Comment: from the graph, we can see that there are lots of outliers with high duration riding time. The distribution of the duration time for casual riders are wider than the members, indicating that the members have a more fixed habit of riding. For months, we can see that there are more outliers in July that many people have a higher duration of riding. People rode electric bike more with a shorter duration than classic bike. 
